...
3. Vul in veld **Opschoningspeildatum** de datum in die door het systeem wordt gebruikt als peildatum voor het selecteren van de verantwoordingen die moeten worden opgeschoond. Alle verantwoordingen worden geschoond waarvan de huurcontractingangsdatum <= de ingevulde opschoningspeildatum. 
...
5. Klik op **OK**. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1OTgzNjQ3NSwzMTM4NDQ4NjgsLTE3Mz
