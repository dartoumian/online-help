...
2. Als u het bedrag van een bestaand element wilt aanpassen, selecteer een element waarvan u het bedrag wil aanpassen en pas de waarde in kolom *Eenheidprijs* aan. 
3. Herhaal dit voor alle elementen waarvan u het bedrag wil aanpassen. 
4. Selecteer een element dat u wilt verwijderen uit het aanbiedingscontract en klik op **Regel verwijderen**. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAwNjI0NjYzNSwxMjk4ODc3MTgzLDE0OD
