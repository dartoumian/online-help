...
2. Klik op de pagina **Aanmaningen** op **Aanmaningen maken**. De pagina **Aanmaningen maken** opent. Vul op deze pagina de volgende velden:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1MTU3NTIwNl19
-->