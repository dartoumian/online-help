...
1. U verstuurt de aanmaningen per aanmaningsniveau. De aanmaningsvoorstellen die niet van het niveau zijn dat u op dit moment wilt aanmanen, dient u te verwijderen. Stel op de pagina **Aanmaningen** een filter in (via filtericoon rechtsboven in het scherm, gevolgd door **+ Filteren...**)  op het veld **Aanmaningsniveau** èn wel zodanig dat in dat u alle aanmaningen die niet van het niveau zijn dat u aan wilt manen, getoond worden binnen het filter. Wilt u bijvoorbeeld niveau 1 versturen, dan stelt u het filter in het veld **Aanmaningsniveau** als volgt in: '<>1' (ongelijk aan 1).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDIzODczMTk4LC0zNDk3NTgyNiwxNzQ4MD
Y4MjE2LDIxMjU3OTU5MThdfQ==
-->